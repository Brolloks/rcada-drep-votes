...
1. **Metadata (Index Card)**  
   At the top of each file is a structured metadata block that records:
   - Governance Action ID
   - Action type
   - Vote (Yes / No / Abstain)
   - Vote date and expiry
...
2. **Analysis & Findings**  
   ...
   - Optional internal scoring used as decision support

3. **RCADA Rationale**  
   A full narrative explanation, written in the same style as RCADA’s historical DRep rationales.  
   This section explains *why* the vote recorded above was cast.
...
- The intent of a proposal is reasonable but execution or process quality is weak
- Proposals are bundled in a way that prevents granular decision-making
- An Info action is being used to imply endorsement without accountability

Abstentions are used to encourage **better governance design**, not to avoid responsibility.

---

## Draft vs Committed Votes
...
## Accountability to Delegators

This repository is intended to:
- Provide a permanent, auditable record of RCADA’s governance activity
- Allow delegators to understand not just *what* was voted, but *why*
- Ensure consistency across time, even as governance evolves
