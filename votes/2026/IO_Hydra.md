---
title: "IO: Hydra"
gov_action_id: "gov_action1fah9m7dxu99af8jqdc4mkrgs3va790nyh9tfhycq2wsvrm47p4rsqtcm6ry"
...
tags: ["treasury", "io", "hydra", "layer-2", "scaling", "infrastructure", "developer-experience", "production-hardening"]
links:
  adastat: "https://adastat.net/governances/4f6e5df9a6e14bd49e406e2bbb0d108b3be2be64b9569b930053a0c1eebe0d4700"
  govtool: ""
  forum: ""
  ipfs: ""
---
...
- The proposal states that Hydra is already used or being evaluated by projects including Delta DeFi, Masumi, Intersect voting infrastructure, VTech Labs, Blockfrost, Hydra Doom, Glacier Drop, and others. :contentReference[oaicite:0]{index=0}
...
- The budget is heavily weighted toward development, with **₳4,386,671**, or **86%**, allocated to development work. :contentReference[oaicite:1]{index=1}
- The proposal includes Intersect administration, milestone-based delivery, third-party assurance, smart-contract-based treasury management, refund conditions, and public reporting commitments. :contentReference[oaicite:2]{index=2}
...
The proposal is administered through Intersect, with funds managed through Treasury smart contracts, milestone-based disbursement, third-party assurance, and refund conditions for unspent or reduced-scope funds. :contentReference[oaicite:4]{index=4}
...
The proposal also discloses prior IO-related Treasury allocations. IO and affiliated entities are stated to have been allocated **₳130,708,860** across Treasury-funded projects, with **₳84,909,073** withdrawn to date. :contentReference[oaicite:5]{index=5}
...
RCADA recognises the concerns around repeated IO Treasury funding. The proposal discloses that IO and affiliated entities have already been allocated **₳130,708,860** across Treasury-funded projects, with **₳84,909,073** withdrawn to date. This does not disqualify the proposal, but it does raise the standard for accountability, transparency, and delivery reporting. :contentReference[oaicite:10]{index=10}
